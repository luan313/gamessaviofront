...
import { Gamepad2, Search, Menu, X, Bell, User as UserIcon, Settings, LogOut, ChevronDown, LogIn, UserPlus } from "lucide-react"
              ...
              <div className="hidden md:flex items-center gap-3">
                ...
                <DropdownMenu>
                  ...
                  >
                    ...
                    <DropdownMenuItem asChild className="rounded-lg focus:bg-blue-600 focus:text-white cursor-pointer mx-1">
                      <Link href="/profile" className="flex items-center gap-3 py-2.5 px-3">
                    ...
                    <DropdownMenuItem asChild className="rounded-lg focus:bg-blue-600 focus:text-white cursor-pointer mx-1">
                      <Link href="/watchlist" className="flex items-center gap-3 py-2.5 px-3">
                    ...
                    <DropdownMenuItem asChild className="rounded-lg focus:bg-blue-600 focus:text-white cursor-pointer mx-1">
                      <Link href="/settings" className="flex items-center gap-3 py-2.5 px-3">
                    ...
                    <DropdownMenuItem
                      ...
                      className="rounded-lg text-red-400 focus:bg-red-500/10 focus:text-red-400 cursor-pointer flex items-center gap-3 py-2.5 px-3 mx-1"
                    >
              ...
              {user ? (
                ...
                <div className="space-y-3">
                  ...
                  <Link href="/register" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button className="w-full h-12 rounded-xl font-bold bg-blue-600 hover:bg-blue-500 text-white">
